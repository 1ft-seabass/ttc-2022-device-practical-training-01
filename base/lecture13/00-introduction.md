...
このデバイス実習 1 の授業では、たとえ理解しきっていなくても知っているところから、つくる一歩を踏み出せるように進めていきました。「まずはうごかす」ということで、手を動かしながら理解していく雰囲気がつかめたでしょう。

新しい知識や技術に触れたとき、分かりきってからでないとつくれないと気負ってしまうかもしれませんが、最近の技術はインターネット上で検索して調べればたくさんの情報が出てくることも多く扱いやすくなっています。

さらに Node-RED のようなローコードツールのサポートがあれば、動かすための設定や情報が GUI で用意されているのではじめやすく、知った段階でも試行錯誤してつくりはじめることができるので、今後もこういったサッと動かしてどんどん良くしていくプロトタイピングの考え方も上手く自分の気持ちに取り込んで、いろいろと作っていきましょう！